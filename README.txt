KOLSEG Design Services WordPress Theme

What is included:
- Theme folder with bundled CSS, JS, and image assets
...
Suggested setup:
1. Install the theme zip in WordPress and activate it.
2. Set Site Title to KOLSEG and Tagline to Design Services.
3. After activation, confirm that the generated pages exist in `Pages`:
   - Home
   - Services
   - Portfolio
   - About
...
4. Edit any page from `Pages` to change text, links, images, and layout sections.
5. If WordPress is still showing old builder content, open `Appearance > Kolseg Setup` and use:
   - `Create / Sync Kolseg Pages`
